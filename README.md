...
## How it was built
Every feature was scoped and built using OpenAI Codex — from the auth flow and Supabase schema to the AI food parser, mood correlation engine, and Coach conversation system. Claude was used as a strategic partner for architecture decisions and prompt engineering.
